...
function ChangeYTURLs($text) {
    $text = preg_replace('~
        ...
        ~ix', 
        '<a href="https://majapahit.net/watch/$1">https://majapahit.net/watch/$1</a>',
        $text);
    return $text;
}
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="lr">
            <iframe src="https://majapahit.net/player.php?id='.$id.'" frameborder="0" width=" 100%" height="40" allowfullscreen></iframe>
