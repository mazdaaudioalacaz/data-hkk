...
$title='Top Songs - '.$sitedes.'';
$description='Download Top Songs in Various Possible qualities, Download Top Songs in Hd, Download Top Songs in Mp4, Download Top Songs in Webm, Download Top Songs in 3gp, Download Top Songs in Mp3, ';
$keywords='Top Songs 3gp, Top Songs Hd, Top Songs Mp4, Top Songs Webm, Top Songs Flv, Top Songs  Mp3, Indian, Pakistani, Bangali, Hollywood, Bollywood, Lollywood, Tik Tok, Whatsapp, Instagram, 3gp, Mp4, Hd';
$ogimg='https://res.cloudinary.com/websmoe/image/upload/v1586116330/majanet/topimages_qhoaou.jpg';
$urlnya=$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
include'includes/header.php';
echo'
<div class="lr">
    <h1 class="hero-header">
        <font color="#E9685D">Top Songs</font>
    </h1>';
...
echo '
<div class="row">';
$string = file_get_contents('https://itunes.apple.com/'.$gl.'/rss/topsongs/limit=72/explicit=true/json');
...
foreach ($json->feed->entry as $item) {
	...
	<div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
		<div style=" border: 1px solid #1D1D25; border-top-right-radius: 5px; border-top-left-radius: 5px;background: #2E2E38; margin:7px;">
			<a href="/songs/'.$search_link.'" alt="'.$item->title->label.' - '.$item->imartist->label.'" title="'.$item->title->label.' - '.$item->imartist->label.'">
